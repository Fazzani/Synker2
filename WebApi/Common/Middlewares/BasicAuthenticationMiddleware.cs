...
namespace hfa.WebApi.Common.Middlewares
{
    ...
    public class BasicAuthenticationMiddleware
    {
        ...
        public ClaimsPrincipal Invoke(HttpContext context, IAuthentificationService authentificationService, SynkerDbContext synkerDbContext, ILoggerFactory loggerFactory)
        {
