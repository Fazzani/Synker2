...
export class HostsComponent implements OnInit, OnDestroy {
    columns = [
        ...
        { columnDef: 'addressUri', header: 'Address', cell: (row: Host) => `${row.addressUri}`, showed: true, actionColumn: false },
    ...
    constructor(private commonService: CommonService, private hostsService: HostsService, public snackBar: MatSnackBar) { }
